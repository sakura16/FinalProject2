...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # The default select value is for ALL sites
                                   dcc.Dropdown(id='site-dropdown',
                                        ...
                                        value='ALL',
                                        placeholder="Select a Luanch Site here",
                                        searchable=True
                                        ),
                                html.Br(),
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = space_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color="Booster Version Category",names='class', 
